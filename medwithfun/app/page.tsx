    ...
    <main className="w-full min-h-screen bg-black text-white font-sans scroll-smooth">
      ...
      <nav className="fixed top-0 w-full z-50 bg-black/80 backdrop-blur-md border-b border-white/10 px-6 md:px-12 py-4 flex items-center justify-between">
        ...
        {isMenuOpen && (
          <div className="md:hidden fixed inset-0 top-[60px] bg-black/95 backdrop-blur-lg flex flex-col items-center justify-start pt-12 gap-6 font-semibold text-lg animate-fade-in z-40 h-screen">
            ...
            <a href="#blog" onClick={() => setIsMenuOpen(false)} className="text-gray-300 hover:text-green-400 transition w-full text-center py-3 border-b border-white/5">Blog</a>
      ...
      <section id="home" className="relative w-full h-screen overflow-hidden flex items-end p-8 md:p-20">
        ...
        <div className="relative z-10 max-w-2xl text-left">
          ...
          <div className="flex gap-4">
            <a href="#ebooks" className="bg-green-500 hover:bg-green-600 text-black font-extrabold px-6 py-3 rounded-xl text-md transition inline-block text-center">
              Explore E-Books 📚
            </a>
            <a href="#facts" className="bg-white/10 hover:bg-white/20 text-white font-bold px-6 py-3 rounded-xl text-md border border-white/20 backdrop-blur-sm transition">
              Learn Daily Facts 💡
            </a>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="h-64 bg-neutral-900 rounded-2xl border border-white/5 mt-8 relative overflow-hidden group shadow-xl">
              <Image src="/histology.jpg" alt="Histology Study" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover group-hover:scale-105 transition duration-500"/>
              <div className="absolute bottom-2 left-3 bg-black/70 backdrop-blur-sm text-[10px] uppercase tracking-wider px-2 py-1 rounded text-green-400 font-bold">
                Histology Labs 🔬
              </div>
            </div>
            <div className="h-64 bg-neutral-900 rounded-2xl border border-white/5 -mt-8 relative overflow-hidden group shadow-xl">
              <Image src="/surgery.jpg" alt="Surgery Room" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover group-hover:scale-105 transition duration-500"/>
              <div className="absolute bottom-2 left-3 bg-black/70 backdrop-blur-sm text-[10px] uppercase tracking-wider px-2 py-1 rounded text-green-400 font-bold">
                Surgery Gear 🩺
              </div>
            </div>
            <div className="h-64 bg-neutral-900 rounded-2xl border border-white/5 relative overflow-hidden group shadow-xl">
              <Image src="/clinical.jpg" alt="Clinical Data" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover group-hover:scale-105 transition duration-500"/>
              <div className="absolute bottom-2 left-3 bg-black/70 backdrop-blur-sm text-[10px] uppercase tracking-wider px-2 py-1 rounded text-green-400 font-bold">
                Clinical Cases 📋
              </div>
            </div>
      ...
      <section id="ebooks" className="py-24 bg-neutral-950 px-6 border-t border-white/10">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <span className="text-xs font-bold text-green-400 tracking-widest uppercase bg-green-500/10 px-3 py-1 rounded-full">Digital Store 📖</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto items-stretch">
            <div className="bg-neutral-900 border border-white/10 p-6 rounded-2xl flex flex-col justify-between hover:border-white/20 transition-all">
              <div>
                ...
                <p className="text-xs text-gray-400 text-left mt-2 leading-relaxed">In this sample e-book, you will get free access to the introductory important chapters and high-yield charts📘✨📊</p>
              </div>
              <div className="mt-8 pt-4 border-t border-white/5 flex items-center justify-between">
                <span className="font-mono font-bold text-green-400 text-lg">₹0 (FREE)</span>
                <button 
                  onClick={() => window.open('https://drive.google.com/file/d/1Rp298KckO6ZYBeWNI4pycl0UBt5naFe4/view?usp=sharing', '_blank')}
            ...
            <div className="bg-gradient-to-br from-neutral-900 to-green-950/30 border border-green-500/20 p-6 rounded-2xl flex flex-col justify-between hover:border-green-500/40 transition-all shadow-xl relative overflow-hidden">
              <div className="absolute top-0 right-0 bg-green-500 text-black text-[9px] font-black uppercase px-3 py-1 rounded-bl-lg tracking-wider">BESTSELLER</div>
              <div>
                ...
                <p className="text-xs text-neutral-300 text-left mt-2 leading-relaxed">Unlock full high-resolution diagrams, complex system shortcuts, animations link, and core revision tools.</p>
                <div className="space-y-2 mt-4 text-left">
                  <input id="rzp-email" type="email" placeholder="Enter your Gmail" className="w-full bg-black/50 border border-white/10 focus:border-green-500 rounded-lg px-3 py-2 text-xs text-white outline-none transition"/>
                  <input id="rzp-phone" type="tel" placeholder="Enter WhatsApp Number" className="w-full bg-black/50 border border-white/10 focus:border-green-500 rounded-lg px-3 py-2 text-xs text-white outline-none transition"/>
                </div>
              </div>
              <div className="mt-6 pt-4 border-t border-white/5 flex items-center justify-between gap-2">
                ...
                <button 
                  onClick={() => {
                    ...
                    if (!emailInput || !phoneInput) { alert("Please fill both Gmail and WhatsApp number first!"); return; }
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 items-center bg-zinc-950 p-8 md:p-12 rounded-3xl border border-zinc-800/80 shadow-2xl">
          <div className="md:col-span-7 space-y-6 text-zinc-300 text-lg md:text-xl leading-relaxed">
            <p className="first-letter:text-5xl first-letter:font-black first-letter:text-green-400 first-letter:mr-3 first-letter:float-left">
              Blogging is one of the best things that can channel my creativity and be involved with a multitude of topics. It is really an amazing platform to reflect on my thoughts, share knowledge, and analyze my learning as a medical student.
            </p>
            <p>
              I'm going to start this blog sharing my insights and information relating to entrance exams into medical school, useful advice about MBBS, or simply because I'm always fascinated by the wonderful and exciting world of medicine. I believe in making the complex simple, sharing experiences, and growing together with my readers.
            </p>
            <div className="pt-4 border-t border-zinc-900">
              <p className="text-base text-zinc-400">If you ever wish to get in touch or you have any questions whatsoever, feel free to reach me at:</p>
          ...
          <div className="md:col-span-5 flex justify-center relative group">
            <div className="absolute -inset-1 bg-gradient-to-r from-green-500 to-yellow-500 rounded-2xl blur opacity-20 group-hover:opacity-40 transition duration-500"></div>
            <Image src="/doctor-pic.jpg" alt="Medical Student Profile" width={400} height={500} className="relative w-full max-w-sm rounded-2xl shadow-2xl border-2 border-zinc-800 object-cover aspect-[4/5] transform group-hover:scale-[1.02] transition duration-500"/>
          </div>
        </div>
      </section>
      ...
      <section id="contact" className="w-full py-20 px-6 max-w-3xl mx-auto border-t border-zinc-900">
        <div className="bg-gradient-to-b from-zinc-950 to-black p-8 md:p-12 rounded-3xl border border-zinc-800/80 shadow-2xl relative overflow-hidden">
          ...
          <h2 className="text-3xl md:text-4xl font-black text-center text-green-400 mb-2 uppercase tracking-wide">Have Questions?</h2>
          <p className="text-center text-zinc-400 max-w-md mx-auto mb-10 text-base md:text-lg">Any doubts regarding the FMGE Blueprint, payment failures, or need access help? Drop a message instantly.</p>
          <form className="flex flex-col gap-5 relative z-10">
            ...
            <button type="submit" className="bg-green-500 hover:bg-green-400 text-black font-black p-4 rounded-xl transition-all uppercase tracking-wider shadow-[0_4px_20px_rgba(34,197,94,0.3)] hover:translate-y-[-2px]">Send Message 🚀</button>
          </form>
          <div className="mt-10 text-center text-zinc-500 text-sm border-t border-zinc-900 pt-6 flex flex-col sm:flex-row justify-center items-center gap-2">
            ...
            <a href="mailto:khanmunkasif@gmail.com" className="text-green-400 font-bold hover:underline">khanmunkasif@gmail.com</a>
          </div>
        </div>
      </section>
